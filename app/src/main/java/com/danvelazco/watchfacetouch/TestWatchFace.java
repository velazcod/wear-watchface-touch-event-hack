...
package com.danvelazco.watchfacetouch;
...
/**
 * Digital watch face with seconds. In ambient mode, the seconds aren't displayed. On devices with low-bit ambient mode,
...
public class TestWatchFace extends CanvasWatchFaceService {
    ...
    private class Engine extends CanvasWatchFaceService.Engine {
        ...
        /**
         * Whether the display supports fewer bits for each color in ambient mode. When true, we disable anti-aliasing
         * in ambient mode.
         */
        ...
        public void onCreate(SurfaceHolder holder) {
            ...
            setWatchFaceStyle(new WatchFaceStyle.Builder(TestWatchFace.this)
                    .setCardPeekMode(WatchFaceStyle.PEEK_MODE_VARIABLE)
                    .setBackgroundVisibility(WatchFaceStyle.BACKGROUND_VISIBILITY_INTERRUPTIVE)
                    .setShowSystemUiTime(false)
                    .build());
            Resources resources = TestWatchFace.this.getResources();
        ...
        private void registerReceiver() {
            ...
            TestWatchFace.this.registerReceiver(mTimeZoneReceiver, filter);
        }
        ...
        private void unregisterReceiver() {
            ...
            TestWatchFace.this.unregisterReceiver(mTimeZoneReceiver);
        }
        ...
        /**
         * Starts the {@link #mUpdateTimeHandler} timer if it should be running and isn't currently or stops it if it
         * shouldn't be running but currently is.
         */
        ...
        /**
         * Returns whether the {@link #mUpdateTimeHandler} timer should be running. The timer should only run when we're
